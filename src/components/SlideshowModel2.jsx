...
import image11 from "../assets/galary/ripd shop/1.jpg";
import image22 from "../assets/galary/ripd shop/2.jpg";
import image33 from "../assets/galary/ripd shop/3.jpg";
import image44 from "../assets/galary/ripd shop/4.jpg";
import image55 from "../assets/galary/ripd shop/5.jpg";
import image66 from "../assets/galary/ripd shop/6.jpg";
import image77 from "../assets/galary/ripd shop/7.jpg";
import image88 from "../assets/galary/ripd shop/8.jpg";
import image99 from "../assets/galary/ripd shop/9.jpg";
import { FaExpand ,FaWindowClose } from 'react-icons/fa';

const SlideshowModal2 = () => {
  const [showModal, setShowModal] = useState(false);
  const [currentSlide, setCurrentSlide] = useState(0);
  const slides = [
    image11,image22,image33,image44,image55,image66,image77,image88,image99
  ];
...
export default SlideshowModal2;
